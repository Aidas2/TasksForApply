...
class Occurrence extends Thread {
    public void countOccurrences(ArrayList<String> arrayList, String string) throws FileNotFoundException {
    ...
    public void printContentToFile(String string) throws FileNotFoundException {
...
//        countOccurrences(words_v_to_z, "from_v_to_z");
        ...
        Occurrence occurrence_ag = new Occurrence();
        Occurrence occurrence_hn = new Occurrence();
        Occurrence occurrence_ou = new Occurrence();
        Occurrence occurrence_vz = new Occurrence();

        occurrence_ag.countOccurrences(words_a_to_g, "from_a_to_g");
        occurrence_hn.countOccurrences(words_h_to_n, "from_h_to_n");
        occurrence_ou.countOccurrences(words_o_to_u, "from_o_to_u");
        occurrence_vz.countOccurrences(words_v_to_z, "from_v_to_z");
